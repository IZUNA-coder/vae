...
public class AppliVAE extends Application {
    ...
    public void afficherChargement() {
        ...
        Timeline checkAttributeTimeline = new Timeline(new KeyFrame(Duration.seconds(1), event -> {
            if (this.isCharger) {
    ...
    public void init() {
        ...
        public void afficheFenetreObjAVendre(Vente v){
            Pane root=null;
            root = new FenetreObjAVendre(this,this.gestionVentes, v, this.btnRetour, this.enchereBd, this.photoBD, this.hyperlinkProfile);
            this.scene.setRoot(root);
        }
        ...
        public void afficheFenetreProfilVendeur(){
            Pane root = new FenetreProfilVendeur(this.hyperlinkAccueil,this.btnRetour, getVendeur(), this.photoBD, this.gestionVentes);
            this.scene.setRoot(root);
        }
