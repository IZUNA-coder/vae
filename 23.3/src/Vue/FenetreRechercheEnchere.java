...
import Controller.ControlleFiltreRechercheFavoris;
...
public class FenetreRechercheEnchere extends BorderPane {
    ...
    private List<CheckBox> filtreCateg;
    ...
    public void init(AppliVAE appli, Button btnRetour, Button btnDeco, GestionVentes gestionVentes, PhotoBD photoBD, TextField navBar,Button btnVendre, Button btnProfil,Button btnVAE) {
        ...
        for(String cat : Categorie.nomCategorie){
            ...
            this.filtreCateg.add(new CheckBox(c.getNom()));
        }
        this.appli = appli;
    ...
    public VBox menuFiltre() {
        ...
        CheckBox checkBox1 = new CheckBox("Bientôt terminées");
        CheckBox checkBox2 = new CheckBox("Mis en ligne récemment");
        CheckBox checkBox3 = new CheckBox("Terminées");

        etatEnch.getChildren().addAll(titreEtatEnch, checkBox1, checkBox2, checkBox3);
        ...
        this.favCheckBox.setOnAction(new ControlleFiltreRechercheFavoris(this, gestionVentes, appli));
        CheckBox dejaEnchCheckBox = new CheckBox("Déjà enchries");

        filtreEnch.getChildren().addAll(titrefiltreEnch, favCheckBox, dejaEnchCheckBox);
        ...
        for(CheckBox cb : this.filtreCateg) {
        	cb.setOnAction(new ControlleFiltreRechercheFavoris(this, gestionVentes, appli));
    ...
    public void setUnselectedBtnFavoris(){
        this.favCheckBox.setSelected(false);
    }
}
