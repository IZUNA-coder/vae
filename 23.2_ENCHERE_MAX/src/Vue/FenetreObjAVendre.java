...
public class FenetreObjAVendre extends BorderPane{
    ...
    public FenetreObjAVendre(GestionVentes gestionVente, Vente vente,Button btnRetour, EnchereBd enchereBd, PhotoBD photoBd, Hyperlink voirProfil){
        super();
        this.vente = vente;
    ...
    public void bas(){
        ...
        for(int i = 0; i < 3; i++){
            ...
            try {
                Vente v = this.gestionVentes.getVenteParCategorie(idCat).get(i);
        ...
        customScrollPane.setMaxWidth(1200);
    ...
    private VBox ajouteCentreGauche(BorderPane bd) {
        ...
        annuler.setOnAction(new ControleurObjetAVendre(this));
        ...
        accepter.setOnAction(new ControleurObjetAVendre(this));
    ...
    public BorderPane ajouteDroite() {
        ...
        Label titre = new Label(this.vente.getObjet().getNom());
    ...
    public Alert popUpOffreAccepter(){
        ...
        alert.setContentText("Vous avez accepter l'offre de " + this.montant + " pour " + this.objet);
    ...
    public Alert popUpOffreRefuser(){
        Alert alert = new Alert(Alert.AlertType.INFORMATION);
        alert.setTitle("Refus de l'offre");
        alert.setHeaderText("A bientôt !");
        alert.setContentText("Vous avez refuser l'offre de " + this.montant + " pour " + this.objet);
        alert.getDialogPane().setMinHeight(Region.USE_PREF_SIZE);
        alert.getDialogPane().setMinWidth(400);
