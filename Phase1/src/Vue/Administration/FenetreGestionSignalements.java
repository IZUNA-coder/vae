...
public class FenetreGestionSignalements extends BorderPane {
    
    private Button btnDeconnexion;
    private Button btnRetourAdmin;
    
    public FenetreGestionSignalements(Button boutonDeco, Button btnRetourAdmin){
        super();
    ...
    private BorderPane enHaut(){
        ...
        Text titre = new Text("Gestion des signalements");
