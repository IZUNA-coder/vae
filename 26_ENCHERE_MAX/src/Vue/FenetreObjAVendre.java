...
public class FenetreObjAVendre extends BorderPane{
    ...
    public void bas(){
        ...
        try {
            ...
            for(int i = 0; i < ind; i++){
                    ...
                    gp1.setOnMouseClicked(new ControllerBtnObjAVendre(this.appli, v,this.enchereBd));
    ...
    this.meilleurEnchere =null;
        ...
        annuler.setOnAction(new ControllerBtnEncherir(this));
    ...
    public Alert popUpOffreAccepter(double encheremax){
        ...
        alert.setContentText("Vous avez surenchéri l'offre de " + String.valueOf(encheremax) + " pour " + String.valueOf(this.getMontantSaisie()));
    ...
    public Alert popUpOffreRefuser(double encheremax){
        ...
        alert.setTitle("Offre invalide");
        alert.setHeaderText("Votre offre est inférieur à l'enchère maximale");
        alert.setContentText("Vous devez surenchérir l'offre d'au moins " + String.valueOf(encheremax+1));
