...
public class FenetreVendre extends BorderPane{
    ...
    public FenetreVendre(Button btnProfil, Button btnVAE, Button btnRetour){
        super();
    ...
    public BorderPane Top(){
        ...
        BorderPane.setMargin(this.btnProfil, new Insets(20));
   ...
   public StackPane barreDeRecherche() {
        ...
        recherche.setStyle("-fx-background-color: transparent;  -fx-background-radius: 50px; -fx-prompt-text-fill: black; -fx-border-color: black; -fx-border-radius: 3em;");
