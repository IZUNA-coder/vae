...
public class FenetreGestionParametres extends BorderPane {
    
    private Button btnDeconnexion;
    private Button btnRetourAdmin;
    
    public FenetreGestionParametres(Button boutonDeco, Button btnRetourAdmin){
        super();
    ...
    private BorderPane enHaut(){
        ...
        Text titre = new Text("Gestion des paramètres");
