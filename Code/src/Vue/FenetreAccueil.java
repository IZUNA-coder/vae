...
public class FenetreAccueil extends BorderPane {
    ...
    public FenetreAccueil(Button btnDeconnexion,Utilisateur user){
        super();
    ...
    private VBox center() {
        ...
        HBox hb = new HBox();
        Button questionPrec = new Button("Question précédente");
        Button questionSuiv = new Button("Question suivante");
        questionPrec.setGraphic(new ImageView(new Image("file:./ressources/graphics/back.png")));
        questionSuiv.setGraphic(new ImageView(new Image("file:./ressources/graphics/next.png")));
        hb.getChildren().addAll(questionPrec,questionSuiv);
